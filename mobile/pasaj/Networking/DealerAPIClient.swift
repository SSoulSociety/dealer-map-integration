...
protocol DealerAPIClient {
    ...
    // Konum bazlı: Türkiye çapında değil, kullanıcının yakın çevresindeki bayileri döner
    // (aksi halde ilk açılışta harita tüm ülkeyi kapsayacak şekilde zoom-out eder).
